...
class MCTS:
    def __init__(self, root_answer, alpha, lambda_0):
        self.exploration_constant_0 = lambda_0  # Paramter \lambda_0
    ...
    def backpropagate(self, node: MCTSNode):
        ...
        while parent:
            ...
            parent.visits += 1
            if parent.parent is not None and parent.parent.code == 'Root':
